...
$resultpet = mysqli_query($connect, $sql);
$rowspet = mysqli_fetch_assoc($resultpet);


$sql = "SELECT * FROM animal WHERE pet_status = 'adopted'";
        ...
        $layout .= "
            <div class='card d-flex justify-content-start my-4'>
                ...
                <div class='card-body'>
                    ...
                    <p class='card-text fw-bold'>Adoption Date:</p><p>{$rowspet["adoption_date"]}</p>
